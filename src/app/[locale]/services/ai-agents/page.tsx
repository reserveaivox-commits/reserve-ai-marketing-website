...
function AgentsSubServices() {
  ...
  const subServices = [
    {
      icon: <Image src="/icons/icon-missed-calls.png" alt="icon" width={48} height={48} className="w-8 h-8 object-contain brightness-0 invert opacity-90" />,
      titleKey: "sub1_title",
      descKey: "sub1_desc",
    },
    {
      icon: <Image src="/icons/icon-wasted-time.png" alt="icon" width={48} height={48} className="w-8 h-8 object-contain brightness-0 invert opacity-90" />,
      titleKey: "sub2_title",
      descKey: "sub2_desc",
    },
    {
    ...
    {
      icon: <Image src="/icons/icon-efficiency.png" alt="icon" width={48} height={48} className="w-8 h-8 object-contain brightness-0 invert opacity-90" />,
      titleKey: "sub4_title",
      descKey: "sub4_desc",
      comingSoon: true,
    },
