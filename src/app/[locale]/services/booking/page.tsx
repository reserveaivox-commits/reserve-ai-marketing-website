...
function BookingHero() {
  ...
  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 service-hero-booking overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimator>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-600 max-w-2xl mx-auto">{t("integrations_subtitle")}</p>
          </div>
        </ScrollAnimator>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i, idx) => (
            <ScrollAnimator key={i} delay={idx * 0.06}>
              <div className="bg-white rounded-xl p-6 text-center shadow-sm hover-lift">
                <p className="text-sm font-medium text-zinc-700">{t(`integration${i}`)}</p>
              </div>
            </ScrollAnimator>
          ))}
        </div>
